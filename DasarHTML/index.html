...
<body>
    <header>
        <div class="jumbotron">
            <h1>D'Paw</h1>
            <p class="jumbotron-p">Selamat Datang di D'Paw</p>
        ...
        <!-- <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="mx-auto order-0">
                <a class="navbar-brand" href="#husky">Siberian Husky</a>
                <a class="navbar-brand" href="#shibainu">Shiba Inu</a>
                <a class="navbar-brand" href="#golden">Golden Retriever</a>
                <button class="theme navbar-brand" onclick="theme()">
                    <img id="brush" role="button" src="assets/image/brush.png">
                </button>
            </div> 
        </nav> -->
        <nav>
            <ul>
                <li><a href="#husky">Siberian Husky</a></li>
                <li><a href="#shibainu">Shiba Inu</a></li>
                <li><a href="#golden">Golden Retriever</a></li>
                <li><button class="theme" onclick="theme()">
                    <img id="brush" role="button" src="assets/image/brush.png">
                    </button>
                </li>
            </ul>
    ...
    <main>
        <div id="katalog">
            <article name="article" id="intro" class="card">
                <h2 class="title">Welcome to D'Paw</h2>
                <img src="assets/image/logo.png" class="featured-image" alt="logo">
                <p>D'Paw merupakan katalog yang menyediakan berbagai info mengenai binatang peliharaan</p>
                <p>Untuk saat ini, kami hanya menyediakan katalog yang berisikan mengenai binatang anjing.</p>
                <p>Pada pengembangan kedepannya, website ini akan menyediakan katalog untuk berbagai jenis binatang.</p>
            </article>
        </div>
        <aside>
            <article name="article" class="profile card">
                <header>
                    <h2 class="title">My Profile</h2>
                    <center>
                        <img src="assets/image/foto.jpg">
                    </center>
                </header>
                <section>
                    <table class="profil">
                        <tr>
                           <th colspan="3">Krisostomos Abdixta Winarto</th>
                        </tr>
                        <tr>
                            <th colspan="3">My Contact</th>
                        </tr>
                        <tr>
                        <tr>
                            <td class="detail"><a target="_blank" href="mailto:krisostomosabdi@gmail.com"><img src="assets/image/gmail.webp"  alt="my email"></a></td>
                            <td class="detail"><a target="_blank" href="https://www.instagram.com/chrysostomus_abdi/"><img src="assets/image/instagram.webp" style="width: 45px;" alt="my instagram"></a></td>
                            <td class="detail"><a target="_blank" href="https://id.linkedin.com/in/krisostomos-abdixta-winarto-34b870217"><img src="assets/image/linkedin.webp"  alt="my linkedin"></a></td>
                        </tr>
                    </table>
                </section>
            </article>
        ...
        <div id="katalog1">
            <article name="article" id="husky" class="card1">
                <h2 class="title">Siberian Husky</h2>
                <!-- <div class="brush-wrap title">
                    <p>Siberian Husky</p>
                </div> -->
                ...
                <div class="flex-container">
                    <div class="flex-item-left">
                        <img src="assets/image/husky.png" class="featured-image" alt="husky">
                    </div>
                    <div class="flex-item-right">
                        <p>Siberian Husky dikenal luas sebagai anjing yang tinggal di iklim dingin. Anjing jenis ini merupakan anjing kereta luncur milik orang-orang Chukchi di Asia Timur Laut. Siberian Husky diandalkan untuk membantu manusia dalam memperluas tempat berburu, karena mereka mampu berlari jarak jauh dengan kecepatan sedang. Selain itu, anjing jenis ini dapat membawa beban ringan dalam suhu yang sangat rendah tanpa menghabiskan banyak energi. </p>              
                        <p>Siberian Husky biasanya sangat menyenangkan jika dijadikan peliharaan. Mereka ramah, ceria, dan memiliki penampilan yang mencolok. Meskipun Husky memiliki banyak ciri yang menarik, mereka mungkin bukan pilihan paling ideal untuk dipelihara. Ini karena mereka memiliki karakteristik tertentu.</p>
                    </div>
                </div>    
            </article>
            
            <article name="article" id="shibainu" class="card1">
                <h2 class="title">Shiba Inu</h2>
                <div class="flex-container">
                    <div class="flex-item-right">
                        <p>Shiba Inu merupakan anjing ras paling populer di Jepang. Tipe anjing berukuran sedang, tinggi badan jantan sekitar 38 cm hingga 41 cm, sedangkan tinggi badan betina sekitar 35 cm hingga 38 cm. Shiba Inu memiliki bulu berwarna cokelat kemerah-merahan, walaupun ada juga Shiba Inu dengan bulu berwarna hitam, dengan lapisan bulu sebelah dalam berwarna coklat muda hingga abu-abu. Bulu pendek terdiri dari dua lapis, lapis atas yang kasar dan lapis dalam yang tebal dan halus. Lapis dalam rontok dan digantikan bulu baru sebanyak dua hingga tiga kali setahun. Shiba Inu juga memiliki kuping berdiri dan ekor melengkung.</p>    
                        <p>Dalam perawatannya, Shiba Inu membutuhkan latihan harian, baik dalam bentuk permainan yang intens di halaman, berjalan-jalan, atau berlarian di area berpagar. Shiba Inu juga merupakan anjing yang sangat aktif, berjiwa bebas, independen, dan suka melakukan apapun yang mereka suka, sehingga tidak disarankan untuk keluar tanpa menggunakan tali kekang pada mereka.</p>
                    </div>
                    <div class="flex-item-left">
                        <img src="assets/image/shiba.png" class="featured-image" alt="geografis">
                    </div>
                </div>   
            </article>

            <article name="article" id="golden" class="card1">
                <h2 class="title">Golden Retriever</h2>
                <div class="flex-container">
                    <div class="flex-item-left">
                        <img src="assets/image/golden.png" class="featured-image" alt="geografis">
                    </div>
                    <div class="flex-item-right">
                        <p>Golden Retriever merupakan anjing dengan ukuran menengah besar. Memiliki tengkorak yang luas dan moncong yang lurus. Hidung berwarna hitam atau hitam kecoklatan. Mata berukuran menengah besar berwarna coklat gelap, telinga yang pendek menggantung dekat pipi. Saat ujung telinga ditarik ke depan, maka akan tepat menutupi mata. Golden Retriever juga memiliki Ekor tebal dengan bulu disepanjang bagian bawahnya.</p>
                        <p>Anjing Golden Retriever merupakan anjing yang menyenangkan, bersahabat, cerdas dengan pesona yang besar. Mereka mudah dilatih, dan selalu sabar dan lembut dengan anak-anak. Anjing Golden Retriever mempunyai sifat setia dan percaya diri, mereka adalah anjing keluarga yang populer. </p> 
                    </div>
                </div> 
            </article>                                        
        </div>
